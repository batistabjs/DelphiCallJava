...
begin
  path := ExtractFilePath(ParamStr(0))
          + 'jdk11\bin\java.exe -jar '
          + ExtractFilePath(ParamStr(0))
          + 'backend\coop-backend-0.0.1-SNAPSHOT.jar bbe81c6a09f9997a47c118dc0d63a42b';
          // como parametro ao levantar o backend, é passado um hashcode do DB
          // para garantir que o front uma requisição segura

  WinExec(PAnsiChar(AnsiString(path)), SW_MINIMIZE);
